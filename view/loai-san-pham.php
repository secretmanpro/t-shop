<?php 
    ...
    $countAllProductById = $data['countAllProductById'];
?>
    <div class="banner-page">
        <img   class=" img-banner-page img-responsive" src="template/images/banner/banner.png" >
        <?php foreach($nameBanner as $sp):?>
              
          <p data-wow-duration="2s"  class="wow bounceIn text-banner">LOẠI SẢN PHẨM 
            <?php if(isset($_GET["maloai"])) echo mb_strtoupper($sp->tenloai,"UTF-8"); ?> </p>
        <?php endforeach?>
    </div>
                    ...
                    <div style="margin-top:20px" class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <?php 
                                ...
                                count($countAllProductById)."&nbsp;"."SẢN PHẨM"."</span>";
                                if(isset($_GET["maloai"])){
                                    if(count($countAllProductById)==0)
                                        echo $none;
                                    else{
                                        echo $rs1;
                                    } 
